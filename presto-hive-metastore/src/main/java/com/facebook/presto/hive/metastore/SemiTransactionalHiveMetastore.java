...
public class SemiTransactionalHiveMetastore
{
            ...
            boolean noNeedToValidatePath)
    {
        ...
        HdfsContext context = new HdfsContext(session, databaseName, tableName, tablePath, isNewTable, noNeedToValidatePath);
    ...
    private class Committer
    {
        ...
        private void prepareAddPartition(MetastoreContext metastoreContext, HdfsContext context, PartitionAndMore partitionAndMore)
        {
            ...
            // because partition path locality has been determined already during early phase of sync logic to identify the partition information
            if (!context.getNoNeedToValidatePath().orElse(false)) {
