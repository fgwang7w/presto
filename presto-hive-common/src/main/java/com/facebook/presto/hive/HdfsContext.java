...
public class HdfsContext
{
    ...
    private final Optional<Boolean> noNeedToValidatePath;
    ...
    public HdfsContext(ConnectorIdentity identity)
    {
        ...
        this.noNeedToValidatePath = Optional.empty();
    }
            ...
            boolean noNeedToValidatePath)
    {
        this(
                ...
                Optional.of(noNeedToValidatePath));
    }
    public HdfsContext(
            ConnectorSession session,
            String schemaName,
    ...
    private HdfsContext(
            ...
            Optional<String> tablePath,
            Optional<Boolean> isNewTable,
            Optional<Boolean> noNeedToValidatePath)
    {
        ...
        this.noNeedToValidatePath = requireNonNull(noNeedToValidatePath, "noNeedToValidatePath is null");
    }
    ...
    public Optional<Boolean> getNoNeedToValidatePath()
    {
        return noNeedToValidatePath;
    }
