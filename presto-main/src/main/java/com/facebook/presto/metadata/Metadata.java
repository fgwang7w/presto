...
public interface Metadata
{
     ...
     */
    @Experimental
    TableLayout getLayout(Session session, TableHandle handle, boolean isReplicatedReadsTable);
    /**
     ...
     */
    TableHandle getAlternativeTableHandle(Session session, TableHandle tableHandle, PartitioningHandle partitioningHandle, boolean isReplicatedReadsTableRequest);
