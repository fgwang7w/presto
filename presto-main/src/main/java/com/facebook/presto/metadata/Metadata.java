...
public interface Metadata
{
     ...
     */
    @Experimental
    TableLayout getLayout(Session session, TableHandle handle, boolean isDimTableReplicated);
    /**
     ...
     */
    TableHandle getAlternativeTableHandle(Session session, TableHandle tableHandle, PartitioningHandle partitioningHandle, boolean isDimTableReplicated);
