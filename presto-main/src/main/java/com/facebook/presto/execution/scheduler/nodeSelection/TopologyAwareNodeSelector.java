        ...
        implements NodeSelector
{
    ...
    {
        return replicatedReadsSelectDistributionNodes(nodeMap.get().get(), nodeTaskMap, maxSplitsWeightPerNode, maxPendingSplitsWeightPerTask, split, existingTasks, partitioning);
    }
