        ...
        implements ConnectorMetadata
{
    ...
    @Override
    public ConnectorTableLayout getTableLayout(ConnectorSession session, ConnectorTableLayoutHandle handle, boolean isDimTableReplicated)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.getTableLayout(session, handle, isDimTableReplicated);
        }
    }
    ...
    @Override
    public ConnectorTableLayoutHandle getAlternativeLayoutHandle(ConnectorSession session, ConnectorTableLayoutHandle tableLayoutHandle, ConnectorPartitioningHandle partitioningHandle, boolean isDimTableReplicated)
    {
        try (ThreadContextClassLoader ignored = new ThreadContextClassLoader(classLoader)) {
            return delegate.getAlternativeLayoutHandle(session, tableLayoutHandle, partitioningHandle, isDimTableReplicated);
        }
    }
