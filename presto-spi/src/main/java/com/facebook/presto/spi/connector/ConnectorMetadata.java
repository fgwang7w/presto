...
public interface ConnectorMetadata
{
    ...
    default ConnectorTableLayout getTableLayout(ConnectorSession session, ConnectorTableLayoutHandle handle, boolean isReplicatedReadsTable)
    {
        if (isReplicatedReadsTable) {
     ...
     */
    default ConnectorTableLayoutHandle getAlternativeLayoutHandle(ConnectorSession session, ConnectorTableLayoutHandle tableLayoutHandle, ConnectorPartitioningHandle partitioningHandle, boolean isReplicatedReadsTableRequest)
    {
